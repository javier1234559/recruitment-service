...
public class LoggingServiceImpl implements LoggingService {
    ...
    public void logRequest(HttpServletRequest httpServletRequest, Object body) {
        RequestResponseLogging reqres = null;

        if (httpServletRequest.getAttribute(Constants.REQUEST_RESPONSE_ATTRIBUTE) == null) {

            reqres = RequestResponseLogging.builder()
                    .uuidRequest(Common.uuid())
                    .method(httpServletRequest.getMethod())
                    .path(httpServletRequest.getRequestURI())
                    .requestHeaders(buildHeadersMap(httpServletRequest))
            ...
            if (body != null) {
                try {
                    reqres.setRequestBody(objectMapper.readValue(
                            objectMapper.writeValueAsString(body), new TypeReference<>() {
                            }));
            ...
            reqres = (RequestResponseLogging) httpServletRequest.getAttribute(Constants.REQUEST_RESPONSE_ATTRIBUTE);
        }
    ...
    public void logResponse(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object body) {
        ...
        RequestResponseLogging reqres = (RequestResponseLogging) httpServletRequest.getAttribute(Constants.REQUEST_RESPONSE_ATTRIBUTE);
        ...
        try {
            reqres.setResponseBody(objectMapper.readValue(
